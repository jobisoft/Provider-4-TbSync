...
values["NameSpace"]        = raw_input("5. A short provider identifier, like 'dav', 'google', which will also be used as its name space inside TbSync: ")
...
if raw_input("Is this correct? (Y/n): ").lower().strip()[:1] == "n":
  ...
  files = {
    ...
    "content/includes/sync.js"               : ["ShortName", "NameSpace", "ChromeUrl"],
    "content/includes/addressbook.js"        : ["ShortName"],
